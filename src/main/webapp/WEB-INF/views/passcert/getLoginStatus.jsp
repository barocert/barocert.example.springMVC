...
<body>
<div id="content">
    <p class="heading1">패스 간편로그인 상태확인 API SDK SpringMVC Example</p>
    <br/>
    <fieldset class="fieldset1">
        ...
        <fieldset class="fieldset2">
            <ul>
                ...
                <li>ReqTitle (간편로그인 요청 메시지 제목) : ${result.reqTitle}</li>
                <li>ReqMessage (간편로그인 요청 메시지 내용) : ${result.reqMessage}</li>
